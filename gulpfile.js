;(() => {
  ...
  const watcher = () => {
    ...
    watch(cfg.src.scss, series(scss, cssPostCSS, cssPurify))
  ...
  exports.default = series(
    parallel(
      ...
      series(scss, cssPostCSS, cssPurify),
  ...
  exports.build = series(
    ...
    parallel(
      ...
      series(scss, cssPostCSS, cssPurify, cssCompress),
  ...
  const mdjson = () =>
    src('./src/content/**/*.md')
      ...
      .pipe(dest('./src/content/json'))

  const copyJson = () =>
    src('./src/content/json/md/**/*.json').pipe(dest('./src/content/json/'))

  const cleanJson = () => {
    return del(['./src/content/json/md/'])
  }

  exports.json = series(mdjson, copyJson, cleanJson)
})()
