...
- enable / disable CSS purify ```const enablePurify = true```
- added doc link with tools  [frontend-toolchain](https://github.com/andreymatin/frontend-toolchain)
- fixed build folder recreation after remove command at the start
